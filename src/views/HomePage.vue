<template>
  <div class="home">
    <div class="products">
      <div class="product" v-for="product in this.products" :key="product.id" :data-ID="product.id"
        ...
        <button v-else @click="removeFromBag(product.id)" class="remove">Remove from
          bag</button>
      </div>
    </div>
  </div>
